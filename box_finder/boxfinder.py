...
def find_box(pix, x, y, width, height):
    ...
    # Runs through every pixel in the detected speed sign and finds the top most, left most, right most
    # and bottom most black pixel
...
def center_calibration(x, y, width, height, pix):
    right_edge_distance = distance_to_right_edge(x, width)
    bottom_edge_distance = distance_to_bottom_edge(y, height)
...
def return_coordinates(image, center_coordinate):
    ...
    (x, y) = center_calibration(x, y, width, height, pix)
